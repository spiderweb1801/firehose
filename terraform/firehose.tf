resource "aws_kinesis_firehose_delivery_stream" "splunk_stream" {
  ...
  splunk_configuration {
    hec_endpoint               = "https://splunk.internal.example.com:8088" //"http://ip-10-0-2-4.ap-south-1.compute.internal:8000" #"http://${module.splunk-aps1.ec2_details.ec2_private_ip}:8000" # http://ip-10-0-2-4.ap-south-1.compute.internal:8000
